package com.roy.anubhav.stackoverflow.QuestionList.personalized;
...
public class PersonalizedTab extends Fragment {
    ...
    public static PersonalizedTab newInstance() {
        return new PersonalizedTab();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.personalized_tab_fragment, container, false);

        //Initalize the recyclerview to hold the questions
        recyclerView = view.findViewById(R.id.questionResults);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mViewModel.getQuestions(tag,"activity").observe(this, new Observer<List<Question>>() {
                @Override
